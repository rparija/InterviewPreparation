...
public class MinNoOfInsertionDeletion {
    ...
    public static void main(String[] args) {
        ...
        int minNumberOfDeletion=s1.length()-lengthOfLongestCommonSubsequence;
        int minNumberOfInsertion=s2.length()-lengthOfLongestCommonSubsequence;
        System.out.println("minNumberOfDeletion & minNumberOfInsertion : "+minNumberOfDeletion+" & "+minNumberOfInsertion);
    }
    ...
    public static int longestCommonSubsequence(String s1,String s2, int m,int n)
    {
        ...
        System.out.println("Longest Common Subsequence: "+stringBuilder.reverse().toString());
        return dp[m][n];
    }
}
